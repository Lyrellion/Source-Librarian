...
export const wiki = {
    ...
    async execute(interaction: ChatInputCommandInteraction): Promise<void> {
        const embed = new EmbedBuilder()
            ...
            .addFields(
                { name: 'Why does my book open the wiki?' , value: "You're mising the [Patchouli](https://www.curseforge.com/minecraft/mc-mods/patchouli) mod, once installed you will be able to browse the book in-game." },
